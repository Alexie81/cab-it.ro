(function () {
  ...
  function mountCabiButton() {
    ...
    var atomicOrbit = '<svg class="cabi-ai-atom" viewBox="0 0 160 160" aria-hidden="true">' +
      '<g transform="rotate(-18 80 80)"><ellipse cx="80" cy="80" rx="67" ry="27"/><circle r="6.2"><animateMotion dur="4.8s" begin="-.9s" repeatCount="indefinite" path="M147 80A67 27 0 1 1 13 80A67 27 0 1 1 147 80"/></circle></g>' +
      '<g transform="rotate(54 80 80)"><ellipse cx="80" cy="80" rx="67" ry="27"/><circle r="5.5"><animateMotion dur="3.9s" begin="-2.1s" repeatCount="indefinite" path="M147 80A67 27 0 1 0 13 80A67 27 0 1 0 147 80"/></circle></g>' +
      '<g transform="rotate(112 80 80)"><ellipse cx="80" cy="80" rx="67" ry="27"/><circle r="4.8"><animateMotion dur="5.7s" begin="-3.4s" repeatCount="indefinite" path="M147 80A67 27 0 1 1 13 80A67 27 0 1 1 147 80"/></circle></g>' +
    '</svg>';
      ...
      '<div class="cabi-ai-panel__surface" role="dialog" aria-modal="true" aria-labelledby="cabi-ai-title" tabindex="-1">' +
        ...
        '<section class="cabi-ai-main">' +
          ...
          '<div class="cabi-ai-canvas">' +
            '<div class="cabi-ai-welcome"><div class="cabi-ai-orbit" aria-hidden="true">' + atomicOrbit + '<span>' + icon + '</span></div><p class="cabi-ai-eyebrow">ORICE ÎNTREBARE. UN SINGUR PUNCT DE PORNIRE.</p><h3>Cum te pot ajuta astăzi?</h3><p>Pe viitor vei putea întreba despre servicii, prețuri, proiecte sau orice informație din website.</p></div>' +
    ...
    if (!doc.getElementById("cabi-smart-button-styles")) {
      ...
      styles.textContent =
        ...
        '@media(prefers-reduced-motion:reduce){.cabi-smart-button,.cabi-ai-panel,.cabi-ai-panel__surface{transition:none}.cabi-ai-atom circle{display:none}.cabi-ai-orbit>.cabi-ai-atom,.cabi-ai-orbit::before,.cabi-ai-orbit>span{animation:none}}' +
