(function () {
  ...
  function mountCabiButton() {
    ...
    var routeIcons = {
      ...
      price: '<svg viewBox="0 0 48 48" aria-hidden="true"><path d="M8 22 22 8h14l4 4v14L26 40 8 22Z"/><circle cx="31.5" cy="16.5" r="2.2"/></svg>',
      seo: '<svg viewBox="0 0 48 48" aria-hidden="true"><path d="m9 35 10-11 7 7 13-17M30 14h9v9"/></svg>',
      ads: '<svg viewBox="0 0 48 48" aria-hidden="true"><path d="M17 35 27.5 12a5 5 0 0 1 9 4.3L26 39"/><path d="M17 35a5 5 0 1 1-9-4.3L18.5 8"/><circle cx="31.5" cy="36" r="5"/></svg>',
      ...
      contact: '<svg viewBox="0 0 48 48" aria-hidden="true"><path d="M15 8h7l3 9-5 4c3 6 7 10 13 13l4-5 9 3v7c0 3.3-2.7 6-6 6C20 43 5 28 3 8c0-3.3 2.7-6 6-6" transform="translate(0 1) scale(.92)"/></svg>'
    };
    var navItems = [
    ...
    if (!doc.getElementById("cabi-smart-button-styles")) {
      ...
      styles.textContent =
        ...
        '.cabi-ai-next{max-width:1040px;margin:30px auto 0}.cabi-ai-actions{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:14px}.cabi-ai-actions a{position:relative;min-width:0;min-height:112px;display:flex;align-items:center;gap:17px;padding:18px 44px 18px 18px;border:1px solid #d9e5e8;border-radius:17px;color:#17273a;background:rgba(255,255,255,.92);box-shadow:0 10px 28px rgba(20,55,65,.045);transition:transform .2s ease,border-color .2s ease,box-shadow .2s ease}.cabi-ai-actions a:hover{border-color:#65d1c7;box-shadow:0 16px 34px rgba(0,111,104,.11);transform:translateY(-3px)}.cabi-ai-actions a>span{width:58px;height:58px;display:grid;place-items:center;flex:0 0 58px;border-radius:50%;color:#087f78;background:linear-gradient(145deg,#eaf9f7,#dff3f1)}.cabi-ai-actions a>span svg{width:34px;height:34px;fill:none;stroke:currentColor;stroke-width:2.5;stroke-linecap:round;stroke-linejoin:round}.cabi-ai-actions a div{min-width:0}.cabi-ai-actions strong,.cabi-ai-actions small{display:block}.cabi-ai-actions strong{font-size:13px;line-height:1.25}.cabi-ai-actions small{margin-top:6px;color:#66768b;font-size:10px;line-height:1.45}.cabi-ai-actions b{position:absolute;right:17px;bottom:15px;color:#079d92;font-size:18px;font-weight:500}' +
        '.cabi-ai-composer{padding:12px clamp(22px,5vw,78px) 14px;background:linear-gradient(180deg,rgba(247,251,251,0),#f7fbfb 24%)}.cabi-ai-composer__box{max-width:1040px;min-height:58px;display:flex;align-items:center;gap:12px;margin:0 auto;padding:9px 10px 9px 16px;border:1.5px solid #30afa5;border-radius:19px;background:rgba(255,255,255,.96);box-shadow:0 15px 35px rgba(0,104,98,.09)}.cabi-ai-composer input{min-width:0;flex:1;height:38px;padding:0;border:0;outline:0;color:#344559;background:transparent;font:500 13px/1.5 Inter,Arial,sans-serif}.cabi-ai-composer input::placeholder{color:#8795a6}.cabi-ai-composer button{width:40px;height:40px;display:grid;place-items:center;flex:0 0 40px;border:0;border-radius:13px;color:#fff;background:linear-gradient(145deg,#006d67,#08aaa0);font-size:20px;cursor:default}.cabi-ai-composer>p{margin:8px 0 0;color:#8390a0;font-size:9px;text-align:center}' +
