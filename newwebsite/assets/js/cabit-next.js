(function () {
  ...
  function mountCabiButton() {
    ...
    var routeIcons = {
      ...
      price: '<svg class="cabi-route-price" viewBox="0 0 48 48" aria-hidden="true"><path d="M4.5 21.5 23 5.5h16.5l4 4v14L25 42.5 4.5 21.5Z"/><circle cx="33.5" cy="14.5" r="2.3"/></svg>',
    ...
    var panelMarkup = '<div class="cabi-ai-panel" id="cabi-ai-panel" data-cabi-panel aria-hidden="true" hidden>' +
      '<div class="cabi-ai-panel__surface" role="dialog" aria-modal="true" aria-labelledby="cabi-ai-title" tabindex="-1">' +
        '<aside class="cabi-ai-sidebar">' +
          ...
          '<p class="cabi-ai-kicker">CONVERSAȚII</p><div class="cabi-ai-recents"><p class="cabi-ai-empty">Nu există conversații încă.</p></div>' +
        ...
        '<section class="cabi-ai-main">' +
          '<header class="cabi-ai-topbar"><div class="cabi-ai-topbar__title"><span class="cabi-ai-topbar__mobile-icon">' + icon + '</span><div><h2 id="cabi-ai-title">Asistent AI CAB-IT <em>BETA</em></h2><p>Asistentul tău AI pentru servicii web și marketing digital</p></div></div><div class="cabi-ai-topbar__tools"><button class="cabi-ai-info" type="button" data-cabi-info aria-label="Despre acest agent" aria-controls="cabi-ai-info-popover" aria-expanded="false"><span aria-hidden="true">?</span></button><div class="cabi-ai-info-popover" id="cabi-ai-info-popover" role="tooltip" aria-hidden="true"><strong>Ce face acest agent?</strong><p>Te ajută să găsești servicii, prețuri, proiecte și articole CAB-IT, apoi te conduce rapid către pagina potrivită. Momentan vezi previzualizarea interfeței.</p></div><button class="cabi-ai-close" type="button" data-cabi-close aria-label="Închide asistentul"><span></span><span></span></button></div></header>' +
          '<div class="cabi-ai-canvas">' +
            ...
            '<div class="cabi-ai-next"><div class="cabi-ai-actions">' +
              '<a href="/servicii/creare-site-web/"><span>' + routeIcons.website + '</span><div><strong>Vreau un website</strong><small>Site de prezentare sau magazin online</small></div><b>→</b></a>' +
              '<a href="/preturi/"><span>' + routeIcons.price + '</span><div><strong>Cât costă un site?</strong><small>Află prețurile pentru website-uri</small></div><b>→</b></a>' +
              '<a href="/servicii/seo/"><span>' + routeIcons.seo + '</span><div><strong>Am nevoie de SEO</strong><small>Optimizare pentru rezultate mai bune în Google</small></div><b>→</b></a>' +
              '<a href="/servicii/reclame-platite/"><span>' + routeIcons.ads + '</span><div><strong>Vreau reclame Google Ads</strong><small>Campanii care aduc clienți și conversii</small></div><b>→</b></a>' +
              '<a href="/portofoliu/"><span>' + routeIcons.portfolio + '</span><div><strong>Arată-mi proiectele</strong><small>Vezi proiectele recente realizate</small></div><b>→</b></a>' +
            ...
            '</div></div>' +
          '</div>' +
          '<footer class="cabi-ai-composer"><div class="cabi-ai-composer__box"><input type="text" aria-label="Mesaj către asistent" placeholder="Scrie întrebarea ta..."><button type="button" aria-label="Trimiterea va fi disponibilă în curând"><span aria-hidden="true">↑</span></button></div><p>Momentan lucrăm doar la design. Funcția AI va fi conectată în etapa următoare.</p></footer>' +
        '</section>' +
      '</div>' +
    '</div>';
    ...
    if (!doc.getElementById("cabi-smart-button-styles")) {
      ...
      styles.textContent =
        ...
        '.cabi-ai-next{max-width:1040px;margin:30px auto 0}.cabi-ai-actions{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:14px}.cabi-ai-actions a{position:relative;min-width:0;min-height:112px;display:flex;align-items:center;gap:17px;padding:18px 44px 18px 18px;border:1px solid #d9e5e8;border-radius:17px;color:#17273a;background:rgba(255,255,255,.92);box-shadow:0 10px 28px rgba(20,55,65,.045);overflow:hidden;transition:transform .2s ease,border-color .2s ease,box-shadow .2s ease}.cabi-ai-actions a:hover,.cabi-ai-actions a:focus-visible{outline:0;border-color:#65d1c7;box-shadow:0 16px 34px rgba(0,111,104,.11);transform:translateY(-3px)}.cabi-ai-actions a:active{transform:translateY(-1px) scale(.985)}.cabi-ai-actions a>span{position:relative;z-index:1;width:58px;height:58px;display:grid;place-items:center;flex:0 0 58px;border-radius:50%;color:#087f78;background:linear-gradient(145deg,#eaf9f7,#dff3f1);transition:transform .24s ease,background .24s ease,box-shadow .24s ease}.cabi-ai-actions a>span svg{width:34px;height:34px;fill:none;stroke:currentColor;stroke-width:2.5;stroke-linecap:round;stroke-linejoin:round}.cabi-ai-actions a>span svg.cabi-route-ads{overflow:visible;fill:none;stroke:none}.cabi-route-ads__right{fill:#087f78;transform-origin:center;transition:transform .28s ease,fill .28s ease}.cabi-route-ads__left{fill:#1fc7b6;transform-origin:center;transition:transform .28s ease,fill .28s ease}.cabi-route-ads__dot{fill:#006b66;transform-origin:8.4px 37px;transition:transform .28s ease,fill .28s ease}.cabi-ai-action--ads::before{position:absolute;content:"";inset:0;background:radial-gradient(circle at 18% 50%,rgba(31,199,182,.18),transparent 35%),linear-gradient(110deg,transparent 55%,rgba(8,127,120,.055));opacity:0;transition:opacity .25s ease}.cabi-ai-action--ads:hover::before,.cabi-ai-action--ads:focus-visible::before{opacity:1}.cabi-ai-action--ads:hover>span,.cabi-ai-action--ads:focus-visible>span{background:linear-gradient(145deg,#d9faf5,#c6eee9);box-shadow:0 10px 22px rgba(0,119,112,.16);transform:scale(1.07) rotate(-2deg)}.cabi-ai-action--ads:hover .cabi-route-ads__right,.cabi-ai-action--ads:focus-visible .cabi-route-ads__right{fill:#006b66;transform:translate(1px,-1px)}.cabi-ai-action--ads:hover .cabi-route-ads__left,.cabi-ai-action--ads:focus-visible .cabi-route-ads__left{fill:#18bdaa;transform:translate(-1px,1px)}.cabi-ai-action--ads:hover .cabi-route-ads__dot,.cabi-ai-action--ads:focus-visible .cabi-route-ads__dot{fill:#064f51;transform:scale(1.16)}.cabi-ai-actions a div{position:relative;z-index:1;min-width:0}.cabi-ai-actions strong,.cabi-ai-actions small{display:block}.cabi-ai-actions strong{font-size:13px;line-height:1.25}.cabi-ai-actions small{margin-top:6px;color:#66768b;font-size:10px;line-height:1.45}.cabi-ai-actions b{position:absolute;z-index:1;right:17px;bottom:15px;color:#079d92;font-size:18px;font-weight:500;transition:transform .2s ease}.cabi-ai-actions a:hover b,.cabi-ai-actions a:focus-visible b{transform:translateX(4px)}' +
        '.cabi-route-price{transform:scaleX(1.12);transform-origin:center}.cabi-route-ads .cabi-route-ads__right,.cabi-route-ads .cabi-route-ads__left{fill:none;stroke-width:8.5;stroke-linecap:round;stroke-linejoin:round}.cabi-route-ads .cabi-route-ads__right{stroke:#087f78}.cabi-route-ads .cabi-route-ads__left{stroke:#23c8b6}.cabi-route-ads .cabi-route-ads__dot{fill:#006b66;stroke:none}.cabi-ai-actions a>span svg.cabi-route-phone{fill:#07966f;stroke:none}' +
        '.cabi-ai-composer{padding:12px clamp(22px,5vw,78px) 14px;background:linear-gradient(180deg,rgba(247,251,251,0),#f7fbfb 24%)}.cabi-ai-composer__box{max-width:1040px;min-height:58px;display:flex;align-items:center;gap:12px;margin:0 auto;padding:9px 10px 9px 16px;border:1.5px solid #30afa5;border-radius:19px;background:rgba(255,255,255,.96);box-shadow:0 15px 35px rgba(0,104,98,.09)}.cabi-ai-composer input{min-width:0;flex:1;height:38px;padding:0;border:0;outline:0;color:#344559;background:transparent;font:500 13px/1.5 Inter,Arial,sans-serif}.cabi-ai-composer input::placeholder{color:#8795a6}.cabi-ai-composer button{position:relative;width:40px;height:40px;display:grid;place-items:center;flex:0 0 40px;border:0;border-radius:13px;color:#fff;background:linear-gradient(145deg,#006d67,#08aaa0);box-shadow:0 8px 18px rgba(0,111,104,.2);font-size:20px;cursor:pointer;overflow:hidden;transition:transform .2s ease,box-shadow .2s ease,filter .2s ease}.cabi-ai-composer button::before{position:absolute;content:"";inset:-2px;border-radius:inherit;background:linear-gradient(120deg,transparent 22%,rgba(255,255,255,.5) 46%,transparent 68%);transform:translateX(-130%);transition:transform .45s ease}.cabi-ai-composer button span{position:relative;z-index:1;display:block;transition:transform .2s ease}.cabi-ai-composer button:hover,.cabi-ai-composer button:focus-visible{outline:0;filter:saturate(1.12);transform:translateY(-2px);box-shadow:0 13px 24px rgba(0,111,104,.31),0 0 0 4px rgba(8,170,160,.12)}.cabi-ai-composer button:hover::before,.cabi-ai-composer button:focus-visible::before{transform:translateX(130%)}.cabi-ai-composer button:hover span,.cabi-ai-composer button:focus-visible span{transform:translateY(-2px)}.cabi-ai-composer button:active{transform:translateY(0) scale(.92);box-shadow:0 5px 12px rgba(0,111,104,.22)}.cabi-ai-composer>p{margin:8px 0 0;color:#8390a0;font-size:9px;text-align:center}' +
