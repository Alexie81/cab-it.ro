...
function cms_article_page(array $article): string
{
    ...
    return '<!doctype html><html lang="ro-RO"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1">' .
        ...
        '<footer class="cabit-site-footer"><div class="container cabit-site-footer__inner"><span>©Copyright <span data-current-year>2026</span> All Rights Reserved</span><span><a href="/blog/">Blog</a> · <a href="/contact/">Contact</a></span></div></footer><script src="../../assets/js/site-enhancements.js?v=20260718-19"></script><script defer src="../../assets/js/cabit-next.js?v=20260718-19"></script></body></html>';
}
...
function cms_work_page(PDO $pdo, array $work): string
{
    ...
    $testimonial = $work['testimonial'] !== '' ? '<section class="cabit-content-section is-soft"><div class="container"><div class="cabit-content-card"><h2>Feedback de la client</h2><blockquote>' . cms_rich_content($work['testimonial']) . '</blockquote></div></div></section>' : '';
    return '<!doctype html><html lang="ro-RO"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1">' .
        ...
        '<section class="cabit-content-section"><div class="container cabit-case-layout"><article><div class="cabit-content-card"><h2>Obiectivul inițial</h2>' . cms_rich_content($work['objective']) . '</div><div class="cabit-content-card"><h2>Ce am făcut</h2>' . cms_rich_content($work['work_done']) . '</div><div class="cabit-content-card"><h2>Rezultate și măsurare</h2>' . cms_rich_content($work['results']) . '</div></article><aside><div class="cabit-note"><strong>Data adăugării</strong><br><time datetime="' . cms_e($work['date_added']) . '">' . cms_e($work['date_added']) . '</time></div>' . $external . '</aside></div></section>' .
        ...
        '<footer class="cabit-site-footer"><div class="container cabit-site-footer__inner"><span>©Copyright <span data-current-year>2026</span> All Rights Reserved</span><span><a href="/portofoliu/">Toate proiectele</a> · <a href="/contact/">Contact</a></span></div></footer><script src="../../assets/js/site-enhancements.js?v=20260718-19"></script><script defer src="../../assets/js/cabit-next.js?v=20260718-19"></script></body></html>';
}
