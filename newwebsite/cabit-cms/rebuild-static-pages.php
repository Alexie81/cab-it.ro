...
const THEME_JS_VERSION = '20260820-21';
const BLOG_EXPLORER_VERSION = '20260820-29';
...
<section class="cabit-page-header cabit-split-hero"><div class="container"><div><span class="cabit-eyebrow">Resurse CAB-IT</span><h1>Marketing digital explicat pentru decizii mai bune.</h1><p>Ghiduri clare despre SEO, promovare online, website-uri și măsurarea rezultatelor. Fără jargon inutil, cu exemple și pași aplicabili.</p><div class="cabit-topic-pills"><a href="/servicii/seo/">SEO</a><a href="/servicii/reclame-platite/">Google Ads</a><a href="/servicii/creare-site-web/">Website</a><a href="/glosar-seo/">Glosar</a></div></div><div class="cabit-editorial-visual"><span class="cabit-editorial-kicker">Biblioteca CAB-IT</span><strong>Răspunsuri potrivite.<br>Pentru întrebările tale.</strong><i class="cabit-editorial-search" aria-hidden="true"><svg viewBox="0 0 24 24"><circle cx="10.5" cy="10.5" r="6.5"/><path d="m15.5 15.5 5 5"/></svg></i><div class="cabit-editorial-topics" aria-hidden="true"><b>SEO</b><b>Website</b><b>Ads</b></div></div></div></section>
<section class="cabit-content-section"><div class="container" data-blog-explorer data-index-url="../blog-search-index.json?v=' . BLOG_EXPLORER_VERSION . '"><div class="cabit-section-heading"><span class="cabit-eyebrow">Biblioteca CAB-IT</span><h2>Găsește rapid articolul potrivit</h2><p>Scrie întrebarea, serviciul sau obiectivul. Sugestiile apar imediat, iar biblioteca de articole se filtrează numai după ce apeși săgeata sau Enter.</p></div><div class="cabit-blog-tools"><form class="cabit-blog-search" role="search" data-blog-search-form><label for="blog-smart-search">Caută în toate articolele</label><div class="cabit-blog-search__field"><span class="cabit-blog-search__indicator" aria-hidden="true"><svg viewBox="0 0 24 24"><circle cx="11" cy="11" r="7"></circle><path d="m16.5 16.5 4 4"></path></svg></span><input id="blog-smart-search" type="search" role="combobox" placeholder="Ex.: cât costă un site, SEO local, Google Ads…" autocomplete="off" aria-autocomplete="list" aria-haspopup="listbox" aria-controls="blog-search-suggestions" aria-expanded="false" data-blog-search><button class="cabit-blog-search__clear" type="button" aria-label="Șterge căutarea" data-blog-search-clear hidden>×</button><button class="cabit-blog-search__submit" type="submit" aria-label="Caută în articole"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M5 12h13"></path><path d="m13 7 5 5-5 5"></path></svg></button></div><div class="cabit-blog-suggestions" id="blog-search-suggestions" role="listbox" data-blog-suggestions hidden></div></form><div class="cabit-blog-page-size"><label for="blog-page-size">Articole pe pagină</label><select id="blog-page-size" data-blog-page-size><option value="10" selected>10 articole</option><option value="20">20 articole</option><option value="50">50 articole</option><option value="100">100 articole</option><option value="all">Toate articolele</option></select></div></div><div class="cabit-blog-result-bar" role="status" aria-live="polite"><span data-blog-result-count><strong>10</strong> articole afișate</span><span data-blog-result-context>ordonate de la cele mai recente</span></div><div class="cabit-blog-grid" id="blog-results" data-blog-results><!-- CMS_BLOG_CARDS_START -->' . $blogCards . '<!-- CMS_BLOG_CARDS_END --></div><nav class="cabit-blog-pagination" aria-label="Paginarea articolelor" data-blog-pagination hidden></nav><noscript><p>Activează JavaScript pentru căutare, selector și paginare. Primele 10 articole sunt afișate mai sus, iar toate paginile sunt disponibile în <a href="../sitemap-articles.xml">sitemap-ul articolelor</a>.</p></noscript></div></section>
<section class="cabit-inner-cta section-shell cabit-blog-cta"><div class="cabit-blog-cta__copy"><span>Ai găsit răspunsul?</span><h2>Transformă ideea într-un plan clar.</h2><p>Discutăm obiectivul, alegem pașii potriviți și stabilim ce merită măsurat.</p><a class="button button-primary" href="/contact/">Hai să construim planul <b aria-hidden="true">→</b></a></div><div class="cabit-blog-cta__visual" aria-hidden="true"><i></i><i></i><i></i><strong>?</strong><b>✓</b></div></section>';
...
$blogHtml = str_replace(
    '<link rel="stylesheet" href="../assets/css/site.min.css?v=' . SITE_ASSET_VERSION . '"><link rel="stylesheet" href="../assets/css/cabit-next.min.css?v=' . THEME_CSS_VERSION . '">',
    '<link rel="stylesheet" href="../assets/css/blog-page.min.css?v=' . BLOG_EXPLORER_VERSION . '"><link rel="stylesheet" href="../assets/css/blog-explorer.min.css?v=' . BLOG_EXPLORER_VERSION . '">',
    $blogHtml
);
$blogHtml = str_replace('</body>', '<script defer src="../assets/js/blog-explorer.min.js?v=' . BLOG_EXPLORER_VERSION . '"></script></body>', $blogHtml);
$blogHtml = str_replace('</head>', '<link rel="alternate" type="application/rss+xml" title="Blog CAB-IT Expert" href="https://cab-it.ro/feed.xml"></head>', $blogHtml);
